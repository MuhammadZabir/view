    ...
    describe('StatusCategory Service', () => {
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/status-categories';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });

            it('should create a StatusCategory', () => {
                service.create(new StatusCategory(null)).subscribe(received => {
            ...
            it('should update a StatusCategory', () => {
                service.update(new StatusCategory(123)).subscribe(received => {
            ...
            it('should return a StatusCategory', () => {
            ...
            it('should return a list of StatusCategory', () => {
                ...
                const req = httpMock.expectOne({ method: 'GET' });
                req.flush([new StatusCategory(123)]);
            });
