    ...
    describe('Achievement Service', () => {
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/achievements';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });

            it('should create a Achievement', () => {
                service.create(new Achievement(null)).subscribe(received => {
            ...
            it('should update a Achievement', () => {
                service.update(new Achievement(123)).subscribe(received => {
            ...
            it('should return a Achievement', () => {
