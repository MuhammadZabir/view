...
import { PointConfigComponent } from 'app/entities/point-config/point-config.component';
...
describe('Component Tests', () => {
    describe('PointConfig Management Component', () => {
        let comp: PointConfigComponent;
        ...
        beforeEach(() => {
            TestBed.configureTestingModule({
                ...
                .overrideTemplate(PointConfigComponent, '')
                .compileComponents();
        ...
        it('Should call load all on init', () => {
            ...
            expect(comp.pointConfigs[0]).toEqual(jasmine.objectContaining({ id: 123 }));
        });
