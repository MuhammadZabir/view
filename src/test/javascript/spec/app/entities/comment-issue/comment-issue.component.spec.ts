...
import { CommentIssueComponent } from 'app/entities/comment-issue/comment-issue.component';
...
describe('Component Tests', () => {
    describe('CommentIssue Management Component', () => {
        let comp: CommentIssueComponent;
        ...
        beforeEach(() => {
            TestBed.configureTestingModule({
                ...
                .overrideTemplate(CommentIssueComponent, '')
                .compileComponents();
        ...
        it('Should call load all on init', () => {
            ...
            expect(comp.commentIssues[0]).toEqual(jasmine.objectContaining({ id: 123 }));
        });
