...
describe('Service Tests', () => {
    describe('Criteria Service', () => {
        ...
        beforeEach(() => {
            ...
            injector = getTestBed();
            service = injector.get(CriteriaService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/criteria';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });

            it('should create a Criteria', () => {
                service.create(new Criteria(null)).subscribe(received => {
            ...
            it('should update a Criteria', () => {
                service.update(new Criteria(123)).subscribe(received => {
